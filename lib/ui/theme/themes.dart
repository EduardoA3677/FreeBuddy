      ...
      ThemeData(
        colorScheme: dynamicScheme ??
            ColorScheme.fromSeed(
              seedColor: const Color(0xFF5D4BDB), // Púrpura más vibrante
              brightness: Brightness.light,
              secondary: const Color(0xFF3F6AEC), // Azul más vibrante para detalles
...
ThemeData darkTheme({ColorScheme? dynamicScheme}) => _customize(
      ThemeData(
        colorScheme: dynamicScheme ??
            ColorScheme.fromSeed(
              seedColor: const Color(0xFF7B68EE), // Púrpura más claro para oscuridad
              brightness: Brightness.dark,
              secondary: const Color(0xFF5C8CF7), // Azul más brillante para detalles en oscuridad
              tertiary:
                  const Color(0xFFFF8F6B), // Naranja más brillante para contraste en oscuridad
              surfaceContainerHighest: const Color(0xFF3C3A45), // Fondo de tarjetas más oscuro
            ),
        useMaterial3: true,
      ),
      isDark: true,
  ...
  return theme.copyWith(
    ...
    cardTheme: CardTheme(
      color: isDark
          ...
          : cs.surfaceContainerHigh, // Mayor contraste en claro y oscuro
