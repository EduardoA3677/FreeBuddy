...
class SharedPreferencesAppSettings implements AppSettings {
  ...
  Future<Preference<bool>> get _debugMode =>
      preferences.then((p) => p.getBool(_Prefs.debugMode.key,
          defaultValue: _Prefs.debugMode.defaultValue));

  Future<Preference<int>> get _themeMode =>
      preferences.then((p) => p.getInt(_Prefs.themeMode.key,
          defaultValue: _Prefs.themeMode.defaultValue));
  ...
  @override
  Future<bool> setDebugMode(bool value) =>
      _debugMode.then((v) => v.setValue(value));

  @override
  Stream<ThemeMode> get themeMode =>
      LazyStream(() => _themeMode).map(_intToThemeMode);
